    ...
    <div>
      <ThemeProvider theme={darkTheme}>
        <Box sx={{ borderBottom: 1, borderColor: "divider" }}>
          <Tabs sx={{}} value={value} onChange={handleChange} aria-label="basic tabs example" centered>
            <Tab color="red" label="Play Guide" {...a11yProps(0)} />
            ...
            <AccordionDetails>
              <List>
                ...
                <ListItemText
                  ...
                  primary={
                    <Typography>
                      • <b>Side effect</b>: You must press a button in the digital companion to see which random event
                      you triggered by skipping.
                    </Typography>
                  }
                />
                <ListItemText
                ...
                <ListItemText
                  ...
                  primary={
                    <Typography>
                      • The viral <u>can be pushed across shortcuts</u> which appropriately uses the given steps as
                      usual.
                    </Typography>
                  }
                />
            ...
            <AccordionDetails>
              <List>
                <ListItemText
                  ...
                  primary={
                    <Typography>
                      ...
                      feels that it is too one-sided, we encourage that you switch the players around or apply any of
                      our optional rules that you can use to balance and make the game more interesting.
                    </Typography>
                  }
                />
                <Divider />
                ...
                <ListItemText
                  ...
                  primary={
                    <Typography>
                      • Survivors are <u>not allowed</u> to communicate in real life with other players at all unless
                      they are currently in the process of trading. This is to add another layer of challenge for
                      experienced survivors to strategize.
                    </Typography>
                  }
                />
                <Divider />
                ...
                <ListItemText
                  ...
                  primary={
                    <Typography>
                      • Aside from the unique keycards, allow baseball bats to double function as a keycard as well.
                      Make sure to announce that you got a baseball bat and show it just like a keycard if playing with
                      this rule.
                    </Typography>
                  }
                />
                ...
                <ListItemText
                  ...
                  primary={
                    <Typography>
                      In addition to all of these, any house rules that don’t break the game fundamentally are a great
                      way to balance the game to your liking.
                    </Typography>
                  }
                />
              </List>
            ...
            <AccordionDetails>
              <List>
                ...
                <ListItemText
                  ...
                  primary={
                    <Typography>
                      ...
                      can search through all the houses for it or wait for another player to unlock the gate for you,
                      but once you've reached the exit node uninfected then you're now one of this game's winners!
                    </Typography>
                  }
                />
                <Divider />
                ...
                <ListItemText
                  ...
                  primary={
                    <Typography>
                      • Cure - cure their infection (need cure item), this ends your turn early but you get an
                      additional turn right after.
                    </Typography>
                  }
                />
                <ListItemText
                ...
                <ListItemText
                  ...
                  primary={
                    <Typography>
                      • You’re current objective changes to moving towards uninfected players so that you can trade
                      items and they can cure you. While infected your actions will be changed as follows:
                    </Typography>
                  }
                />
                <ListItemText
                ...
                <ListItemText
                  ...
                  primary={
                    <Typography>
                      ...
                      lose. If you want to win, then make sure to cure other survivors whenever possible so that they
                      can do the same for you. Or at the very least escape before being infected yourself!
                    </Typography>
                  }
                />
                <ListItemText
            ...
            <AccordionDetails>
              <List>
                ...
                <ListItemText
                  ...
                  primary={
                    <Typography>
                      ...
                      have either escaped or are currently infected, then the game ends. The amount of infected players
                      at the end will determine your performance.
                    </Typography>
                  }
                />
                <ListItemText
                ...
                <ListItemText
                  ...
                  primary={
                    <Typography>
                      • Even though you’ve already lost, you can still drag down the remaining survivors down with you
                      so try your best not to be the only loser in the group!
                    </Typography>
                  }
                />
                <Divider />
                ...
                <ListItemText
                  ...
                  primary={
                    <Typography>
                      ...
                      Skills under require the ability directly above it to be available with Apex needed both sides
                      maxed out.
                    </Typography>
                  }
                />
                ...
                <ListItemText
                  ...
                  sx={{ textAlign: "start", paddingLeft: "32px" }}
                  primary={
                    <Typography>• can overwrite existing obstacles because of its acidic properties.</Typography>
                  }
                />
                <ListItemText
                  disableTypography
            ...
            <AccordionDetails>
              <List>
                ...
                <ListItemText
                  ...
                  primary={
                    <Typography>
                      ...
                      <u>Map Guide - Nodes</u> for more details. The events for these are the same for viral and
                      survivor.
                    </Typography>
                  }
                />
                ...
                <ListItemText
                  ...
                  primary={
                    <Typography>
                      <b>• Lucky day (20%)</b> - shuffle discard pile and draw one, if discard pile is empty then no
                      card is drawn.
                    </Typography>
                  }
                />
            ...
            <AccordionDetails>
              <List>
                ...
                <ListItemText
                  ...
                  primary={
                    <Typography>
                      • Most items can only be used at the start of your turn with the exception of the keycard,
                      weapons, and cure items.
                    </Typography>
                  }
                />
                <ListItemText
                ...
                <ListItemText
                  ...
                  primary={
                    <Typography>
                      • prevents bite infections for the rest of the turn and pushes viral one node away (can use
                      anytime a viral tries to infect you) (you can choose where the viral gets pushed)
                    </Typography>
                  }
                />
                <ListItemText
                ...
                <ListItemText
                  ...
                  primary={
                    <Typography>
                      • prevents bite infections for the rest of the turn and pushes viral 3 nodes away (can use anytime
            ...
            <AccordionDetails>
              <List>
                ...
                <ListItemText
                  ...
                  primary={
                    <Typography>
                      • note that the <u>black path connected to the exit</u> is elevated and NOT connected to the
                      pathway directly below it aside from the ladder.
                    </Typography>
                  }
                />
                <Divider />
                ...
                <ListItem sx={{ display: "flex", paddingLeft: "16px" }}>
                  ...
                  <ListItem sx={{ display: "block" }}>
                    ...
                    <ListItemText
                      ...
                      sx={{ textAlign: "start", paddingLeft: "16px" }}
                      primary={
                        <Typography>• a survivor may not enter the same house twice in the same game</Typography>
                      }
                    />
                    <ListItemText
                      disableTypography
                ...
                <ListItem sx={{ display: "flex", paddingLeft: "16px" }}>
                  ...
                  <ListItem sx={{ display: "block" }}>
                    ...
                    <ListItemText
                      ...
                      primary={
                        <Typography>
                          • the viral can set this on an adjacent node before choosing to move/skip
                        </Typography>
                      }
                    />
                    <ListItemText
                ...
                <ListItem sx={{ display: "flex", paddingLeft: "16px" }}>
                  ...
                  <ListItem sx={{ display: "block" }}>
                    ...
                    <ListItemText
                      ...
                      primary={
                        <Typography>
                          • When landing on an event node, there is a chance that these will spawn
                        </Typography>
                      }
                    />
                    <ListItemText
                ...
                <ListItem sx={{ display: "flex", paddingLeft: "16px" }}>
                  ...
                  <ListItem sx={{ display: "block" }}>
                    ...
                    <ListItemText
                      ...
                      primary={
                        <Typography>
                          • not an obstacle but an item for the viral which functions similarly to the food item card.
                          (+1 dice roll, use at the start of turn)
                        </Typography>
                      }
                    />
                    <ListItemText
            ...
            <AccordionDetails>
              <List>
                ...
                <ListItemText
                  ...
                  primary={
                    <Typography>
                      • Please refer to the individual item descriptions. As a general rule, all items can only be used
                      at the start of your turn except for Cure, Keycard, and Weapons.
                    </Typography>
                  }
                />
                <Divider />
